 ...
 */
let ws;
const {create, call} = /**@type {import('../src/_clawffee/internal/Hooks/HookHelper').HookHelper<(path: string[], data: any) => void>} **/ (require('../src/_clawffee/internal/Hooks/HookHelper').simpleHookMgr());
const {create: createAlways, call: callAlways} = /**@type {import('../src/_clawffee/internal/Hooks/HookHelper').HookHelper<(path: string[], data: any) => void>} **/ (require('../src/_clawffee/internal/Hooks/HookHelper').simpleHookMgr());
